                  ...
                  {Object.keys(variants).includes("yellow") &&
                    Object.keys(variants["yellow"]).includes(size) && (
                      <button
                        ...
                        className={`border-2 border-gray-300 ml-1 bg-yellow-600 rounded-full w-6 h-6 focus:outline-none ${
                          color === "yellow"
                            ? "border-black"
                            : "border-gray-300"
                        }`}
                  ...
                  {Object.keys(variants).includes("purple") &&
                    Object.keys(variants["purple"]).includes(size) && (
                      <button
                        ...
                        className={`border-2 border-gray-300 ml-1 bg-purple-700 rounded-full w-6 h-6 focus:outline-none ${
                          color === "purple"
                            ? "border-black"
                            : "border-gray-300"
                        }`}
              ...
              <div className="flex">
                ...
                {product.availableQty > 0 ? (
                  <button
                    ...
                    className="flex ml-8 text-white bg-red-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-red-600 rounded"
                  >
                    Add to cart
                  </button>
                ) : (
                  <button
                    disabled
                    className="flex ml-8 text-white bg-red-300 border-0 py-2 px-2 md:px-6 focus:outline-none rounded"
                  >
                    Add to cart later
                  </button>
                )}
                ...
                {product.availableQty > 0 ? (
                  ...
                  <button
                    disabled
                    className="flex ml-4 text-white bg-red-300 border-0 py-2 px-2 md:px-6 focus:outline-none rounded"
                  >
                    Buy Later
                  </button>
                )}
            ...
            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
              ...
              <div className="pin mt-6 flex space-x-2 text-sm">
                <input
                  ...
                  className="px-2 border-2 border-red-200 rounded-md"
                  placeholder="Enter your pincode"
                  type="text"
                />
                <button
                  onClick={checkServiceAvailability}
                  className="flex ml-14 text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded"
                >
                  Check
                </button>
              </div>
              {!service && service != null && (
                <div className="text-red-700 text-sm mt3">
                  Sorry! We do not deliver currently in this area.
                </div>
              )}
              {service && service != null && (
                <div className="text-green-700 text-sm mt3">
